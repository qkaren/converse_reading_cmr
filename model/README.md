...
**5) To download the model checkpoint**
 ...
 Please download this checkpoint [file](https://drive.google.com/file/d/1Wm5VQriCaAF3l3C571y_XzhYp75BzZ9w/view?usp=sharing) and extract it under `checkpoint`. Then add `--resume './checkpoint/san_checkpoint.pt‘` into `sh run_preprocessing.sh`
