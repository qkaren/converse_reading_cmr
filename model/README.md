...
**2) Download files too large to fit as supplementary materials**
  ...
  Please download this tar gzip [file](https://drive.google.com/file/d/1tMCNv8COw0B3wBRkZ_7fI3h6yaSiJ0b-/view?usp=sharing) and extract it under `./data` folder. If you extracted in a different location, please make sure it is renamed as `data`.
